...
class ElasticCommand extends Command
{
    ...
    {
        $data = json_decode(file_get_contents('/app/resources/movies.json'), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        return $this->client ??= ClientBuilder::create()->setHosts(['elasticsearch'])->build();
    }
}
